...
public class StubMediaBrowserServiceCompat extends MediaBrowserServiceCompat {
    ...
    private Result<List<MediaBrowserCompat.MediaItem>> mPendingLoadChildrenResult;
    private Result<MediaBrowserCompat.MediaItem> mPendingLoadItemResult;
    ...
    public void sendDelayedNotifyChildrenChanged() {
        if (mPendingLoadChildrenResult != null) {
            mPendingLoadChildrenResult.sendResult(Collections.<MediaBrowserCompat.MediaItem>emptyList());
    ...
    public void sendDelayedItemLoaded() {
        if (mPendingLoadItemResult != null) {
            mPendingLoadItemResult.sendResult(new MediaBrowserCompat.MediaItem(new MediaDescriptionCompat.Builder()
    ...
    private MediaBrowserCompat.MediaItem createMediaItem(String id) {
