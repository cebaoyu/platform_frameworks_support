...
/**
 * Test {@link MediaBrowserServiceCompat}.
 */
...
public class MediaBrowserServiceCompatTest {
    ...
    public void testSearch() throws Exception {
        ...
        synchronized (mWaitLock) {
            ...
            for (MediaBrowserCompat.MediaItem item : mSearchCallback.mSearchResults) {
    ...
    private class SearchCallback extends MediaBrowserCompat.SearchCallback {
        ...
        List<MediaBrowserCompat.MediaItem> mSearchResults;
