...
import gsc.support.v4.app.SupportActivity;
import gsc.support.v4.media.MediaDescriptionCompat;
import gsc.support.v4.media.MediaMetadataCompat;
import gsc.support.v4.media.RatingCompat;
import gsc.support.v4.media.VolumeProviderCompat;
import gsc.support.v4.media.session.PlaybackStateCompat.CustomAction;
...
import gsc.support.v4.media.MediaBrowserCompat;
...
public final class MediaControllerCompat {
    ...
    public void removeQueueItemAt(int index) {
        ...
        if (queue != null && index >= 0 && index < queue.size()) {
            MediaSessionCompat.QueueItem item = queue.get(index);
            if (item != null) {
