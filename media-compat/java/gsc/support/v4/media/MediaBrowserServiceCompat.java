...
import static gsc.support.annotation.RestrictTo.Scope.LIBRARY_GROUP;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_ADD_SUBSCRIPTION;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_CONNECT;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_DISCONNECT;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_GET_MEDIA_ITEM;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_REGISTER_CALLBACK_MESSENGER;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_REMOVE_SUBSCRIPTION;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_SEARCH;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_SEND_CUSTOM_ACTION;
import static gsc.support.v4.media.MediaBrowserProtocol.CLIENT_MSG_UNREGISTER_CALLBACK_MESSENGER;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_CALLBACK_TOKEN;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_CALLING_UID;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_CUSTOM_ACTION;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_MEDIA_ITEM_ID;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_MEDIA_SESSION_TOKEN;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_OPTIONS;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_PACKAGE_NAME;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_RESULT_RECEIVER;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_ROOT_HINTS;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_SEARCH_EXTRAS;
import static gsc.support.v4.media.MediaBrowserProtocol.DATA_SEARCH_QUERY;
import static gsc.support.v4.media.MediaBrowserProtocol.EXTRA_CLIENT_VERSION;
import static gsc.support.v4.media.MediaBrowserProtocol.EXTRA_MESSENGER_BINDER;
import static gsc.support.v4.media.MediaBrowserProtocol.EXTRA_SERVICE_VERSION;
import static gsc.support.v4.media.MediaBrowserProtocol.EXTRA_SESSION_BINDER;
import static gsc.support.v4.media.MediaBrowserProtocol.SERVICE_MSG_ON_CONNECT;
import static gsc.support.v4.media.MediaBrowserProtocol.SERVICE_MSG_ON_CONNECT_FAILED;
import static gsc.support.v4.media.MediaBrowserProtocol.SERVICE_MSG_ON_LOAD_CHILDREN;
import static gsc.support.v4.media.MediaBrowserProtocol.SERVICE_VERSION_CURRENT;
...
import gsc.support.annotation.IntDef;
...
import gsc.support.v4.app.BundleCompat;
import gsc.support.v4.media.session.IMediaSession;
import gsc.support.v4.media.session.MediaSessionCompat;
import gsc.support.v4.os.BuildCompat;
import gsc.support.v4.os.ResultReceiver;
import gsc.support.v4.util.ArrayMap;
import gsc.support.v4.util.Pair;
