...
import gsc.support.v4.app.test.FragmentTestActivity;
...
public class FragmentReplaceTest {
    ...
    public void testReplaceFragment() throws Throwable {
        ...
        fm.beginTransaction()
                .add(R.id.content, FragmentTestActivity.TestFragment.create(R.layout.fragment_a))
                .addToBackStack(null)
                .commit();
        ...
        fm.beginTransaction()
                .add(R.id.content, FragmentTestActivity.TestFragment.create(R.layout.fragment_b))
                .addToBackStack(null)
                .commit();
        executePendingTransactions(fm);
        assertNotNull(activity.findViewById(R.id.textA));
        ...
        activity.getSupportFragmentManager().beginTransaction()
                .replace(R.id.content, FragmentTestActivity.TestFragment.create(R.layout.fragment_c))
                .addToBackStack(null)
                .commit();
        executePendingTransactions(fm);
