...
import gsc.support.v4.view.GravityCompat;
...
import gsc.support.v4.content.pm.ShortcutInfoCompat;
...
public class NotificationCompat {
    ...
    public static final class CarExtender implements Extender {
         ...
         * the {@link NotificationCompat.Builder#extend(NotificationCompat.Extender)}
         ...
         *
         * Android Auto uses the color set with {@link NotificationCompat.Builder#setColor(int)}
         ...
         * specified by {@link NotificationCompat.Builder#setLargeIcon(android.graphics.Bitmap)}
         *
