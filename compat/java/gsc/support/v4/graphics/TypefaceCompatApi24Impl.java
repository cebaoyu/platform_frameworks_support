...
import gsc.support.v4.content.res.FontResourcesParserCompat.FontFileResourceEntry;
...
class TypefaceCompatApi24Impl implements TypefaceCompat.TypefaceCompatImpl {
    ...
    @Override
    public Typeface createTypeface(Context context, @NonNull FontsContractCompat.FontInfo[] fonts,
