...
import gsc.support.v4.content.res.FontResourcesParserCompat.FamilyResourceEntry;
import gsc.support.v4.content.res.FontResourcesParserCompat.FontFamilyFilesResourceEntry;
import gsc.support.v4.content.res.FontResourcesParserCompat.ProviderResourceEntry;
import gsc.support.v4.provider.FontsContractCompat;
import gsc.support.v4.util.LruCache;
...
public class TypefaceCompat {
    ...
    interface TypefaceCompatImpl {
        ...
        Typeface createTypeface(Context context, @NonNull FontsContractCompat.FontInfo[] fonts,
     ...
     */
    public static Typeface createTypeface(Context context, @NonNull FontsContractCompat.FontInfo[] fonts,
            Map<Uri, ByteBuffer> uriBuffer) {
