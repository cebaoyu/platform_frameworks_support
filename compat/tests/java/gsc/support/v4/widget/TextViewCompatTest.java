...
import static gsc.support.v4.testutils.TextViewActions
...
import gsc.support.v4.BaseInstrumentationTestCase;
import gsc.support.v4.testutils.TestUtils;
...
import gsc.support.v4.testutils.LayoutDirectionActions;
import gsc.support.v4.testutils.TextViewActions;
...
public class TextViewCompatTest extends BaseInstrumentationTestCase<TextViewTestActivity> {
    ...
    public void testMaxLines() throws Throwable {
        ...
        onView(withId(R.id.text_view)).perform(TextViewActions.setMaxLines(maxLinesCount));

        assertEquals("Empty view: Max lines must match", TextViewCompat.getMaxLines(mTextView),
                maxLinesCount);

        onView(withId(R.id.text_view)).perform(TextViewActions.setText(R.string.test_text_short));
        assertEquals("Short text: Max lines must match", TextViewCompat.getMaxLines(mTextView),
                maxLinesCount);

        onView(withId(R.id.text_view)).perform(TextViewActions.setText(R.string.test_text_medium));
        assertEquals("Medium text: Max lines must match", TextViewCompat.getMaxLines(mTextView),
                maxLinesCount);

        onView(withId(R.id.text_view)).perform(TextViewActions.setText(R.string.test_text_long));
    ...
    public void testMinLines() throws Throwable {
        ...
        onView(withId(R.id.text_view)).perform(TextViewActions.setMinLines(minLinesCount));
    ...
    public void testStyle() throws Throwable {
        onView(withId(R.id.text_view)).perform(TextViewActions.setTextAppearance(R.style.TextMediumStyle));
    ...
    public void testCompoundDrawablesRelative() throws Throwable {
        ...
        onView(withId(R.id.text_view)).perform(TextViewActions.setText(R.string.test_text_medium));
        onView(withId(R.id.text_view)).perform(TextViewActions.setCompoundDrawablesRelative(drawableStart,
    ...
    public void testCompoundDrawablesRelativeRtl() throws Throwable {
        onView(withId(R.id.text_view)).perform(LayoutDirectionActions.setLayoutDirection(ViewCompat.LAYOUT_DIRECTION_RTL));
    ...
    public void testCompoundDrawablesRelativeWithIntrinsicBounds() throws Throwable {
        ...
        onView(withId(R.id.text_view)).perform(TextViewActions.setText(R.string.test_text_long));
        onView(withId(R.id.text_view)).perform(
                TextViewActions.setCompoundDrawablesRelativeWithIntrinsicBounds(
