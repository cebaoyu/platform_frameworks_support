...
class FocusStrategy {
    public static <L, T> T findNextFocusInRelativeDirection(@NonNull L focusables,
            ...
            @Nullable T focused, @ViewCompat.FocusRelativeDirection int direction, boolean isLayoutRtl,
            boolean wrap) {
    ...
    private static boolean isBetterCandidate(
            @ViewCompat.FocusRealDirection int direction, @NonNull Rect source,
     ...
     */
    private static boolean beamBeats(@ViewCompat.FocusRealDirection int direction,
    ...
    private static boolean isCandidate(@NonNull Rect srcRect, @NonNull Rect destRect,
            @ViewCompat.FocusRealDirection int direction) {
        switch (direction) {
            case View.FOCUS_LEFT:
     ...
     */
    private static boolean beamsOverlap(@ViewCompat.FocusRealDirection int direction,
     ...
     */
    private static boolean isToDirectionOf(@ViewCompat.FocusRealDirection int direction,
     ...
     * returns 0.
     */
    private static int majorAxisDistance(@ViewCompat.FocusRealDirection int direction,
            @NonNull Rect source, @NonNull Rect dest) {
        return Math.max(0, majorAxisDistanceRaw(direction, source, dest));
    }

    private static int majorAxisDistanceRaw(@ViewCompat.FocusRealDirection int direction,
            @NonNull Rect source, @NonNull Rect dest) {
        switch (direction) {
            case View.FOCUS_LEFT:
     ...
     */
    private static int majorAxisDistanceToFarEdge(@ViewCompat.FocusRealDirection int direction,
            @NonNull Rect source, @NonNull Rect dest) {
     ...
     * @return the distance
     */
    private static int minorAxisDistance(@ViewCompat.FocusRealDirection int direction, @NonNull Rect source,
            @NonNull Rect dest) {
        switch (direction) {
            case View.FOCUS_LEFT:
            case View.FOCUS_RIGHT:
